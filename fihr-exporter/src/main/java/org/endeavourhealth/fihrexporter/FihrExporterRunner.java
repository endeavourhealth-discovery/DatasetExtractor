...
import org.endeavourhealth.fihrexporter.exception.FihrExporterException;
...
public class FihrExporterRunner {
    ...
    public static void main(String... args) throws IOException, SQLException {
        ...
        try (  FihrExporter csvExporter = new FihrExporter( properties  ) ) {
            ...
            log.info("Starting fihr exporter...");
    ...
    private static Properties loadProperties(String[] args) throws IOException {
        ...
        if(args.length == 0) throw new FihrExporterException("Required args is absent [tablename]");

        Properties properties = new Properties();

        InputStream inputStream = FihrExporterRunner.class.getClassLoader().getResourceAsStream("csv.exporter.properties");
